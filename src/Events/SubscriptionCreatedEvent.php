...
/**
 * Dispatched when Paystack fires a `subscription.create` webhook event.
 *
 * Listen to this event to handle a new subscription has been created.
...
class SubscriptionCreatedEvent
{
    ...
    /**
     * Create a new SubscriptionCreatedEvent instance.
     *
