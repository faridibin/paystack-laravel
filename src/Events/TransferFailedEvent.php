...
/**
 * Dispatched when Paystack fires a `transfer.failed` webhook event.
 *
 * Listen to this event to handle a transfer attempt has failed.
...
class TransferFailedEvent
{
    ...
    /**
     * Create a new TransferFailedEvent instance.
     *
