...
/**
 * Dispatched when Paystack fires a `invoice.create` webhook event.
 *
 * Listen to this event to handle an invoice has been created for a subscription.
...
class InvoiceCreatedEvent
{
    ...
    /**
     * Create a new InvoiceCreatedEvent instance.
     *
